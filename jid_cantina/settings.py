...
if TOKEN_CSRF:
    ...
    CSRF_TRUSTED_ORIGINS = ['https://projetocantinajid-production.up.railway.app/']
else:
...
ALLOWED_HOSTS = ["https://projetocantinajid-production.up.railway.app/", "localhost", "127.0.0.1"]
